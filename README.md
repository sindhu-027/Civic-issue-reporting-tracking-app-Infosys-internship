...
- 🛠️ Final Frontend (Admin Dashboard Only): ![Annapoorna SJ](https://img.shields.io/badge/AnnapoornaSJ-Frontend_Admin-red)
...
### **Backend (Render Node API):**  
🔗 https://civic-issue-reporting-tracking-app.onrender.com
...
CLIENT_URL=https://civic-issue-reporting-tracking-app-9lml.onrender.com
```

#### **Frontend `.env`:**
```env
VITE_API_URL=https://civic-issue-reporting-tracking-app.onrender.com
VITE_SOCKET_URL=https://civic-issue-reporting-tracking-app.onrender.com
VITE_ENV=production
```
...
- Final project submitted by **Team 1**  
- Developed using MERN stack with full authentication & live updates  
